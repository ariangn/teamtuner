...
function activate(context) {
    ...
    // APIに実際にエラー情報を送信する関数
    async function sendErrorsToAPI(error) {
        // ここでエラー情報をAPIに送信します
        const payloads = {
        ...
        try {
            const response = await axios_1.default.post('http://localhost:3000/send-message', payloads, {
                headers: {
...
const FormData$1 = __webpack_require__(4);
const url = __webpack_require__(12);
const proxyFromEnv = __webpack_require__(28);
const http = __webpack_require__(10);
const https = __webpack_require__(11);
const util = __webpack_require__(6);
const followRedirects = __webpack_require__(29);
...
var CombinedStream = __webpack_require__(5);
...
var populate = __webpack_require__(27);
...
var util = __webpack_require__(6);
var Stream = (__webpack_require__(7).Stream);
var DelayedStream = __webpack_require__(8);
...
module.exports =
{
  parallel      : __webpack_require__(18),
  serial        : __webpack_require__(25),
...
var iterate    = __webpack_require__(19)
  , initState  = __webpack_require__(23)
  , terminator = __webpack_require__(24)
  ;
...
var defer = __webpack_require__(21);
...
var abort = __webpack_require__(22)
...
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41);
